...
nltk.download('punkt')
nlp = spacy.load('/workspaces/ResumeAnalyser/sections/models/en_core_web_sm/en_core_web_sm-2.3.1')
import sqlite3
...
def run():
    ...
    if uploaded_file is not None:
        ...
        # Monkey patch only inside pyresparser
        pyresparser.resume_parser.spacy.load = lambda name: original_spacy_load("/workspaces/ResumeAnalyser/sections/models/en_core_web_sm/en_core_web_sm-2.3.1")
